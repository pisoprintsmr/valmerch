       ...
       ?>
        ...
        <div class="row align-items-center mx-5 mt-3">
              <div class="col text-center">
                <img src="images/logoFillPink.png" alt="" class="imglog">
              </div><br>
              <div class="col fade_body imglog2">
                  <br><p class="mb-0">
                    <strong>Valmerch</strong> is an e-commerce platform that caters to players of Valorant who are interested in purchasing 
                    merchandise connected to the game, such as t-shirts, sweatshirts, ID laces, and mousepads, among other items. <br><br>
                    <strong>Val Merch</strong> is created and aims to produce delicate and good quality clothing collections appealing to every Valorant players. <br><br>
				    Val merch is the ultimate destination for purchasing merchandise from the most famous first-person shooter (FPS) Valorant. <br><br>
				<italic>Choose among unique designs or settle with your favorite agent in the game. </italic> <br><br>
                <strong>We offer the best services and products to satisfy your gamer needs.</strong><br></p><br>
              </div>
            </div>
        </div>  
        </div>
